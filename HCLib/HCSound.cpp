...
int HCSound::DMusic_Shutdown(void)
{
...
int HCSound::DMusic_Init(HWND main_window_handle)
{
...
int HCSound::DMusic_Status_MIDI(int id)
{
...
int HCSound::DMusic_Delete_All_MIDI(void)
{
	// delete all the MIDI 
	int index; // loop var
...
int HCSound::DMusic_Delete_MIDI(int id)
{
...
int HCSound::DMusic_Stop(int id)
{
	// stop a midi segment
	if (dm_midi[id].dm_segment && dm_midi[id].state!=MIDI_NULL)
	{
...
int HCSound::DMusic_Play(int id)
{
...
int HCSound::DMusic_Load_MIDI(char *filename)
{
...
int HCSound::DSound_Status_Sound(int id)
{
...
int HCSound::DSound_Stop_All_Sounds(void)
{
...
int HCSound::DSound_Delete_Sound(int id)
{
...
int HCSound::DSound_Delete_All_Sounds(void)
{
...
int HCSound::DSound_Stop_Sound(int id)
{
...
int HCSound::DSound_Set_Pan(int id,int pan)
{
...
int HCSound::DSound_Set_Freq(int id,int freq)
{
...
int HCSound::DSound_Set_Volume(int id,int vol)
{
...
int HCSound::DSound_Play(int id, int flags, int volume, int rate, int pan)
{
...
int HCSound::DSound_Shutdown(void)
{
...
int HCSound::DSound_Init(HWND main_window_handle)
{
...
int HCSound::DSound_Replicate_Sound(int source_id)
{
...
int HCSound::DSound_Load_WAV(char *filename, int control_flags)
{
